...
const Newsletter = ({ type, title, summary, img, link }) => {
  return (
    <article
    ...
    >
      ...
      >
        ...
        <Link
          href={link} // read direects to the full blog
        ...
        <Layout className="pt-16">
          ...
          >
            <div className="col-span-2">
              <Newsletter
                type=""
                title="You matter: It’s okay not to be okay"
                summary="According to the CDC, Mental health includes our emotional, psychological, and social well-being. It affects how we think, feel, and act. It also helps determine how we handle stress, relate to others, and make healthy choices."
                img={blog11}
                link="/blog1"
              />
            </div>
